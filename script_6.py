# Create a comprehensive deployment script for easy setup
...
# Also create a simple batch file for Windows users
windows_batch = '''@echo off
echo.
echo ================================================
echo MineGuard 3D - Quick Setup for Windows
echo ================================================
echo.
...
echo
echo "================================================"
echo "MineGuard 3D - Quick Setup for Linux/Mac"
echo "================================================"
echo
...
print("  • setup.py (Main deployment script)")
print("  • setup_windows.bat (Windows batch file)")
print("  • setup_unix.sh (Linux/Mac shell script)")